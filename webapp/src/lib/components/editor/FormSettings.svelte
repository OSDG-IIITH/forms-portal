	...
	<div class="grid grid-cols-1 gap-6 pt-2">
		<div class="space-y-2">
			...
			<div class="flex gap-2">
				<DatePicker bind:value={formData.opens} placeholder="Select open date" class="flex-1" />
				<div class="w-22">
		...
		<div class="space-y-2">
			...
			<div class="flex gap-2">
				<DatePicker bind:value={formData.closes} placeholder="Select close date" class="flex-1" />
				<div class="w-22">
